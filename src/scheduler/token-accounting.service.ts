 ...
 *
 * В agents.name у части строк лежит технический слаг вместо имени. Списание за
 * голосовую консультацию 07.09.2026 уехало строкой «Ответ ассистента
 * «smm_producer»» — слаг из базы утёк в текст, который читает пользователь.
 * Тот ассистент с тех пор удалён, но слаги в agents.name никуда не делись, и
 * защита нужна ровно так же.
 *
