 ...
 * узнать об этом владельцу больше неоткуда: общего списка продуктов у
 * администратора нет, уведомлений кусок 4б не делает, единственный след —
 * `block_reason` в карточке и этот текст. Получив «Продукт сейчас недоступен
