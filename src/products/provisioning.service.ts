...
export class ProvisioningService implements OnModuleInit, OnModuleDestroy {
   ...
   *      ничему), то есть его задания не достанутся никому и никогда. До
   *      задачи 4 так выглядит каждый только что заведённый продукт, и пусть
   *      об этом будет сказано вслух: без этого условия кабинет отвечал бы
   *      «всё в порядке» ровно тому, чья работа не уедет никуда.
   *
   * ЧЕГО ЗДЕСЬ СОЗНАТЕЛЬНО НЕТ — ответа «куда уедет СЛЕДУЮЩИЙ продукт». Машину
   * новому продукту выбирает задача 4 по аудитории и свободным местам; гадать
   * за неё здесь значило бы завести второе правило выбора машины, которое
   * разойдётся с настоящим молча. У владельца без продуктов цена названа
