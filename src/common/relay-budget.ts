 ...
 * сам вызов релея и потолок ожидания инструмента продуктов, а с 26.09.2026 —
 * ещё и ход Маши в локальном CLI: у неё тот же инструмент, и её ход обязан
 * вмещать ожидание правки так же, как ход релея.
 *
