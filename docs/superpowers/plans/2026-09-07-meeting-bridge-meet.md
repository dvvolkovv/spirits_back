...
| 9. Аудио-мост | **Ждёт спайка (вопрос 3)** |
| 10. Проводка в `agent.ts` | **Ждёт спайка (вопрос 3)** |
...
| 16. Живая проверка и деплой | **Ждёт 9-10** |
...
**Что осталось написать после спайка:** только задачи 9 и 10. Всё остальное,
включая уборку бота и учёт, уже на месте — воркеру не хватает ровно двух
вещей: концов сессии, привязанных к вебсокету, и источника присутствия вместо
