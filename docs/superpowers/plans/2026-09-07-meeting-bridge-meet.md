...
| 2. Спайк | Вопросы 1-5 закрыты: 5 — по исходникам, 1-4 — живой встречей 09.09.2026. Открыты 6 (точный контракт создания бота) и 7 (сброс очереди звука при перебивании) |
