...
Attendee поднят на тестовом стенде, цепочка проверена вживую на настоящей
встрече Google Meet: бот вошёл, звук прошёл в обе стороны, Роман говорил,
транскрипт и списание сработали. Подробности прогона, замеры и три найденных
им дефекта — в `infra/attendee/README.md`. В прод Attendee пока не тащим:
задача стенда была убедиться, что путь не тупиковый.
