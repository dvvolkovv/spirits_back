...
Путь оказался не тупиковым, но и не бесплатным: до рабочего состояния
потребовались семь исправлений, из них одно — **локальная правка самого
Attendee** (`infra/attendee/patches/mic-label-tolerant.py`), без которой
ассистента во встрече не слышно вовсе. Правку надо применять после каждого
обновления Attendee.
